	...
	<body>
			...
			<?php
			 ...
			 if($resultado)
			 {
              ...
              echo "<button onclick=window.location='cursosAdmin.html'>Regresar a todos los cursos</button>";
             }
  ...
  //-----------------------------------------------------------------------------------------------------------------------
       ...
       function  resetDefault()
       {
           ...
           function getValues(id)
           {
               ...
               valores[4]="<a href=mostrarLeccion.php?idLeccion="+id+" target='_blank'>Ver leccion</a>";
               return valores;
           }
		</script>
	</body>
