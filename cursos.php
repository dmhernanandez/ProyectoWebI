  ...
  <img class="logo" src="./images/logo.png"  width="300px" alt="">
    ...
    <header>
        <nav class="navegacion">
            <ul class="menu">
                ...
                <div class="usuario">
                    <button class="dropbtn">Pedro Perez</button>
                    <div class="drop">
                        <a href="E-learning.html"><i class='fas fa-inbox' style='font-size:15px;color:black'></i>Actualizar</a>
                        <a href="#"><i class='fas fa-power-off' style='font-size:15px;color:black'></i>Salir</a>
                    </div>
                </div>
            </ul>
    ...
    <div class="descripcion">
      ...
      <div class="espana">
        ...
        <article id="c3" class="cur">
          <a class="ver-curso" href="cplus.html">
            <img src="./images/cpp.png"  alt="">
            <hr>
            <h2 class="nombre-curso">Programacion en C++</h2>
            <span class="separador"></span>
            <p class="nombre-instructor">Pedro Juan</p>
            <h4 class="tutor">Tutor</h4>
